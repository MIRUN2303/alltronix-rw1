...
export default function GlassCard({
  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-2xl border border-[#e5e5e5] bg-white backdrop-blur-xl ${hover ? 'hover:border-[#cc0000]/30 hover:shadow-md hover:-translate-y-1 transition-all duration-500' : ''} ${className}`}
      style={{
