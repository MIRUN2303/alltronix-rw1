...
export default function Button({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-[#cc0000] to-[#ef4444] text-white shadow-lg shadow-red-500/25 hover:shadow-red-500/40 hover:-translate-y-0.5',
    ...
    ghost: 'bg-transparent text-[#888] hover:text-[#cc0000] hover:bg-red-50',
  }
