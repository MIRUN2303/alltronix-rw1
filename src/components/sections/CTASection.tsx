...
export default function CTASection() {
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-[#f8f8f8]">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-r from-[#005bb5]/6 to-[#0072e3]/3 blur-[150px]" />
      <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1a1a1a] leading-tight">
            ...
            <span className="bg-gradient-to-r from-[#cc0000] to-[#0072e3] bg-clip-text text-transparent">
              Next Project?
            </span>
          </h2>
