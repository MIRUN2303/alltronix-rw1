          ...
          {focusedIndustries.map((industry, i) => (
            ...
            >
              <Link
                ...
                className="group block bg-white rounded-xl overflow-hidden border border-[#e0e0e0] hover:border-[#cc0000]/30 hover:shadow-xl transition-all duration-400 hover:-translate-y-1"
              >
                {/* Image */}
                ...
                <div className="px-5 py-4">
                  <h3 className="text-base font-bold text-[#1a1a1a] group-hover:text-[#cc0000] transition-colors duration-300">
                    {industry.name}
                  </h3>
