            ...
            <ScrollReveal>
              <div className="max-w-3xl">
                ...
                <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-bold text-[#1a1a1a] leading-tight">
                  An{' '}
                  <span className="bg-gradient-to-r from-[#cc0000] to-[#ef4444] bg-clip-text text-transparent">
                    ISO-9001:2015
                  </span>{' '}
                  Certified Company
                </h1>
              ...
              <ScrollReveal direction="right">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <GlassCard className="p-6">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#cc0000]/20 to-[#ef4444]/10 flex items-center justify-center mb-3">
                  ...
                  <GlassCard className="p-6 sm:col-span-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {companyInfo.values.map((v) => (
                        <span key={v} className="px-3 py-1.5 text-sm rounded-full bg-[#cc0000]/10 text-[#cc0000] border border-[#cc0000]/15">{v}</span>
                      ))}
                    </div>
                  </GlassCard>
                </div>
                  ...
                  <ScrollReveal key={item.year} delay={index * 0.1}>
                    <div className="flex gap-8 items-start">
                      <div className="relative flex-shrink-0">
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#cc0000] to-[#ef4444] flex items-center justify-center font-bold text-white text-sm shadow-lg shadow-[#cc0000]/25">
                          {item.year}
                        </div>
                      </div>
                      <div className="pt-3">
