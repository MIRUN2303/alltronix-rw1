              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="space-y-4">
                  <GlassCard className="p-5 flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#cc0000]/20 to-[#ef4444]/10 flex items-center justify-center shrink-0">
                  ...
                  <GlassCard className="p-5 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${companyInfo.contact.phone}`} className="text-sm text-[#cc0000] hover:text-[#ef4444] transition-colors mt-1 block">{companyInfo.contact.phone}</a>
                    </div>
                  </GlassCard>
                  ...
                  <GlassCard className="p-5 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${companyInfo.contact.email}`} className="text-sm text-[#cc0000] hover:text-[#ef4444] transition-colors mt-1 block">{companyInfo.contact.email}</a>
                    </div>
                  </GlassCard>
                  ...
                  <GlassCard className="p-8 lg:p-10">
                    {submitted ? (
                      <div className="text-center py-16">
                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#cc0000] to-[#ef4444] flex items-center justify-center mx-auto mb-4">
                        ...
                        <div className="grid sm:grid-cols-2 gap-5">
                          <div>
                            ...
                            <input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                              className="w-full px-4 py-3 rounded-xl bg-[#f8f8f8] border border-[rgba(204,0,0,0.12)] text-[#1a1a1a] placeholder-[#999] focus:outline-none focus:border-[#cc0000] focus:ring-1 focus:ring-[#cc0000] transition-all" placeholder="Your name" />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-[#666] mb-2">Email *</label>
                            <input type="email" required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })}
                              className="w-full px-4 py-3 rounded-xl bg-[#f8f8f8] border border-[rgba(204,0,0,0.12)] text-[#1a1a1a] placeholder-[#999] focus:outline-none focus:border-[#cc0000] focus:ring-1 focus:ring-[#cc0000] transition-all" placeholder="your@email.com" />
                          </div>
                        </div>
                        <div className="grid sm:grid-cols-2 gap-5">
                          <div>
                            ...
                            <input type="tel" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                              className="w-full px-4 py-3 rounded-xl bg-[#f8f8f8] border border-[rgba(204,0,0,0.12)] text-[#1a1a1a] placeholder-[#999] focus:outline-none focus:border-[#cc0000] focus:ring-1 focus:ring-[#cc0000] transition-all" placeholder="+91 98765 43210" />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-[#666] mb-2">Company</label>
                            <input type="text" value={formData.company} onChange={(e) => setFormData({ ...formData, company: e.target.value })}
                              className="w-full px-4 py-3 rounded-xl bg-[#f8f8f8] border border-[rgba(204,0,0,0.12)] text-[#1a1a1a] placeholder-[#999] focus:outline-none focus:border-[#cc0000] focus:ring-1 focus:ring-[#cc0000] transition-all" placeholder="Company name" />
                          </div>
                        </div>
                        <div>
                          ...
                          <textarea rows={5} required value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })}
                            className="w-full px-4 py-3 rounded-xl bg-[#f8f8f8] border border-[rgba(204,0,0,0.12)] text-[#1a1a1a] placeholder-[#999] focus:outline-none focus:border-[#cc0000] focus:ring-1 focus:ring-[#cc0000] transition-all resize-none" placeholder="Tell us about your project..." />
                        </div>
                        <div className="pt-2">
